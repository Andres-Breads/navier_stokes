...
if __name__ == '__main__':
    ...
    matriz_funciones_x[0] = lambda W,U: W[0]*((W[1]-1)/2)+U[0]*((W[6])/2)-W[1]-1-W[6]+4*W[0]
    matriz_funciones_x[1] = lambda W,U: W[1]*((W[2]-W[0])/2)+U[1]*((W[7])/2)-W[2]-W[0]-W[7]+4*W[1]
    matriz_funciones_x[2] = lambda W,U: W[2]*((W[3]-W[1])/2)+U[2]*((W[8])/2)-W[3]-W[1]-W[8]+4*W[2]
    matriz_funciones_x[3] = lambda W,U: W[3]*((W[4]-W[2])/2)+U[3]*((W[9])/2)-W[4]-W[2]-W[9]+4*W[3]
    matriz_funciones_x[4] = lambda W,U: W[4]*((W[5]-W[3])/2)+U[4]*((W[10])/2)-W[5]-W[3]-W[10]+4*W[4]
    matriz_funciones_x[5] = lambda W,U: W[5]*((-W[4])/2)+U[5]*((W[11])/2)-W[4]-W[11]+4*W[5]
    matriz_funciones_x[6] = lambda W,U: W[6]*((W[7]-1)/2)+U[6]*((W[12]-W[0])/2)-W[7]-1-W[12]-W[0]+4*W[6]
    matriz_funciones_x[7] = lambda W,U: W[7]*((W[8]-W[6])/2)+U[7]*((W[13]-W[1])/2)-W[8]-W[6]-W[13]-W[1]+4*W[7]
    matriz_funciones_x[8] = lambda W,U: W[8]*((W[9]-W[7])/2)+U[8]*((W[14]-W[2])/2)-W[9]-W[7]-W[14]-W[2]+4*W[8]
    matriz_funciones_x[9] = lambda W,U: W[9]*((W[10]-W[8])/2)+U[9]*((W[15]-W[3])/2)-W[10]-W[8]-W[15]-W[3]+4*W[9]
    matriz_funciones_x[10] = lambda W,U: W[10]*((W[11]-W[9])/2)+U[10]*((W[16]-W[4])/2)-W[11]-W[9]-W[16]-W[4]+4*W[10]
    matriz_funciones_x[11] = lambda W,U: W[11]*((-W[10])/2)+U[11]*((W[17]-W[5])/2)-W[10]-W[17]-W[5]+4*W[11]
    matriz_funciones_x[12] = lambda W,U: W[12]*((W[13]-1)/2)+U[12]*((W[21]-W[6])/2)-W[13]-1-W[21]-W[6]+4*W[12]
    matriz_funciones_x[13] = lambda W,U: W[13]*((W[14]-W[12])/2)+U[13]*((W[22]-W[7])/2)-W[14]-W[12]-W[22]-W[7]+4*W[13]
    matriz_funciones_x[14] = lambda W,U: W[14]*((W[15]-W[13])/2)+U[14]*((W[23]-W[8])/2)-W[15]-W[13]-W[23]-W[8]+4*W[14]
    matriz_funciones_x[15] = lambda W,U: W[15]*((W[16]-W[14])/2)+U[15]*((-W[9])/2)-W[16]-W[14]-W[9]+4*W[15]
    matriz_funciones_x[16] = lambda W,U: W[16]*((W[17]-W[15])/2)+U[16]*((-W[10])/2)-W[17]-W[15]-W[10]+4*W[16]
    matriz_funciones_x[17] = lambda W,U: W[17]*((W[18]-W[16])/2)+U[17]*((-W[11])/2)-W[18]-W[16]-W[11]+4*W[17]
    matriz_funciones_x[18] = lambda W,U: W[18]*((W[19]-W[17])/2)+U[18]*((W[24])/2)-W[19]-W[17]-W[24]+4*W[18]
    matriz_funciones_x[19] = lambda W,U: W[19]*((W[20]-W[18])/2)+U[19]*((W[25])/2)-W[20]-W[18]-W[25]+4*W[19]
    matriz_funciones_x[20] = lambda W,U: W[20]*((-W[19])/2)+U[20]*((W[26])/2)-W[19]-W[26]+4*W[20]
    matriz_funciones_x[21] = lambda W,U: W[21]*((W[22]-1)/2)+U[21]*((W[27]-W[12])/2)-W[22]-1-W[27]-W[12]+4*W[21]
    matriz_funciones_x[22] = lambda W,U: W[22]*((W[23]-W[21])/2)+U[22]*((W[28]-W[13])/2)-W[23]-W[21]-W[28]-W[13]+4*W[22]
    matriz_funciones_x[23] = lambda W,U: W[23]*((-W[22])/2)+U[23]*((W[29]-W[14])/2)-W[22]-W[29]-W[14]+4*W[23]
    matriz_funciones_x[24] = lambda W,U: W[24]*((W[25])/2)+U[24]*((W[30]-W[20])/2)-W[25]-W[30]-W[20]+4*W[24]
    matriz_funciones_x[25] = lambda W,U: W[25]*((W[26]-W[24])/2)+U[25]*((W[31]-W[19])/2)-W[26]-W[24]-W[31]-W[19]+4*W[25]
    matriz_funciones_x[26] = lambda W,U: W[26]*((-W[25])/2)+U[26]*((W[32]-W[20])/2)-W[25]-W[32]-W[20]+4*W[26]
    matriz_funciones_x[27] = lambda W,U: W[27]*((W[28]-1)/2)+U[27]*((W[33]-W[21])/2)-W[28]-1-W[33]-W[21]+4*W[27]
    matriz_funciones_x[28] = lambda W,U: W[28]*((W[29]-W[27])/2)+U[28]*((W[34]-W[22])/2)-W[29]-W[27]-W[34]-W[22]+4*W[28]
    matriz_funciones_x[29] = lambda W,U: W[29]*((-W[28])/2)+U[29]*((W[35]-W[23])/2)-W[28]-W[35]-W[23]+4*W[29]
    matriz_funciones_x[30] = lambda W,U: W[30]*((W[31])/2)+U[30]*((W[36]-W[24])/2)-W[31]-W[36]-W[24]+4*W[30]
    matriz_funciones_x[31] = lambda W,U: W[31]*((W[32]-W[30])/2)+U[31]*((W[37]-W[25])/2)-W[32]-W[30]-W[37]-W[25]+4*W[31]
    matriz_funciones_x[32] = lambda W,U: W[32]*((-W[31])/2)+U[32]*((W[38]-W[26])/2)-W[31]-W[38]-W[26]+4*W[32]
    matriz_funciones_x[33] = lambda W,U: W[33]*((W[34]-1)/2)+U[33]*((-W[27])/2)-W[34]-1-W[27]+4*W[33]
    matriz_funciones_x[34] = lambda W,U: W[34]*((W[35]-W[33])/2)+U[34]*((-W[28])/2)-W[35]-W[33]-W[28]+4*W[34]
    matriz_funciones_x[35] = lambda W,U: W[35]*((-W[34])/2)+U[35]*((-W[29])/2)-W[34]-W[29]+4*W[35]
    matriz_funciones_x[36] = lambda W,U: W[36]*((W[37])/2)+U[36]*((-W[30])/2)-W[37]-W[30]+4*W[36]
    matriz_funciones_x[37] = lambda W,U: W[37]*((W[38]-W[36])/2)+U[37]*((-W[31])/2)-W[38]-W[36]-W[31]+4*W[37]
    matriz_funciones_x[38] = lambda W,U: W[38]*((-W[37])/2)+U[38]*((-W[32])/2)-W[37]-W[32]+4*W[38]

    matriz_funciones_y = list()
    matriz_funciones_y[0] = lambda W,U: W[0]*((U[1])/2)+U[0]*((U[6])/2)-U[1]-U[6]+4*U[0]
    matriz_funciones_y[1] = lambda W,U: W[1]*((U[2]-U[0])/2)+U[1]*((U[7])/2)-U[2]-U[0]-U[7]+4*U[1]
    matriz_funciones_y[2] = lambda W,U: W[2]*((U[3]-U[1])/2)+U[2]*((U[8])/2)-U[3]-U[1]-U[8]+4*U[2]
    matriz_funciones_y[3] = lambda W,U: W[3]*((U[4]-U[2])/2)+U[3]*((U[9])/2)-U[4]-U[2]-U[9]+4*U[3]
    matriz_funciones_y[4] = lambda W,U: W[4]*((U[5]-U[3])/2)+U[4]*((U[10])/2)-U[5]-U[3]-U[10]+4*U[4]
    matriz_funciones_y[5] = lambda W,U: W[5]*((-U[4])/2)+U[5]*((U[11])/2)-U[4]-U[11]+4*U[5]
    matriz_funciones_y[6] = lambda W,U: W[6]*((U[7])/2)+U[6]*((U[12]-U[0])/2)-U[7]-U[12]-U[0]+4*U[6]
    matriz_funciones_y[7] = lambda W,U: W[7]*((U[8]-U[6])/2)+U[7]*((U[13]-U[1])/2)-U[8]-U[6]-U[13]-U[1]+4*U[7]
    matriz_funciones_y[8] = lambda W,U: W[8]*((U[9]-U[7])/2)+U[8]*((U[14]-U[2])/2)-U[9]-U[7]-U[14]-U[2]+4*U[8]
    matriz_funciones_y[9] = lambda W,U: W[9]*((U[10]-U[8])/2)+U[9]*((U[15]-U[3])/2)-U[10]-U[8]-U[15]-U[3]+4*U[9]
    matriz_funciones_y[10] = lambda W,U: W[10]*((U[11]-U[9])/2)+U[10]*((U[16]-U[4])/2)-U[11]-U[9]-U[16]-U[4]+4*U[10]
    matriz_funciones_y[11] = lambda W,U: W[11]*((-U[10])/2)+U[11]*((U[17]-U[5])/2)-U[10]-U[17]-U[5]+4*U[11]
    matriz_funciones_y[12] = lambda W,U: W[12]*((U[13])/2)+U[12]*((U[21]-U[6])/2)-U[13]-U[21]-U[6]+4*U[12]
    matriz_funciones_y[13] = lambda W,U: W[13]*((U[14]-U[12])/2)+U[13]*((U[22]-U[7])/2)-U[14]-U[12]-U[22]-U[7]+4*U[13]
    matriz_funciones_y[14] = lambda W,U: W[14]*((U[15]-U[13])/2)+U[14]*((U[23]-U[8])/2)-U[15]-U[13]-U[23]-U[8]+4*U[14]
    matriz_funciones_y[15] = lambda W,U: W[15]*((U[16]-U[14])/2)+U[15]*((-U[9])/2)-U[16]-U[14]-U[9]+4*U[15]
    matriz_funciones_y[16] = lambda W,U: W[16]*((U[17]-U[15])/2)+U[16]*((-U[10])/2)-U[17]-U[15]-U[10]+4*U[16]
    matriz_funciones_y[17] = lambda W,U: W[17]*((U[18]-U[16])/2)+U[17]*((-U[11])/2)-U[18]-U[16]-U[11]+4*U[17]
    matriz_funciones_y[18] = lambda W,U: W[18]*((U[19]-U[17])/2)+U[18]*((U[24])/2)-U[19]-U[17]-U[24]+4*U[18]
    matriz_funciones_y[19] = lambda W,U: W[19]*((U[20]-U[18])/2)+U[19]*((U[25])/2)-U[20]-U[18]-U[25]+4*U[19]
    matriz_funciones_y[20] = lambda W,U: W[20]*((-U[19])/2)+U[20]*((U[26])/2)-U[19]-U[26]+4*U[20]
    matriz_funciones_y[21] = lambda W,U: W[21]*((U[22])/2)+U[21]*((U[27]-U[12])/2)-U[22]-U[27]-U[12]+4*U[21]
    matriz_funciones_y[22] = lambda W,U: W[22]*((U[23]-U[21])/2)+U[22]*((U[28]-U[13])/2)-U[23]-U[21]-U[28]-U[13]+4*U[22]
    matriz_funciones_y[23] = lambda W,U: W[23]*((-U[22])/2)+U[23]*((U[29]-U[14])/2)-U[22]-U[29]-U[14]+4*U[23]
    matriz_funciones_y[24] = lambda W,U: W[24]*((U[25])/2)+U[24]*((U[30]-U[20])/2)-U[25]-U[30]-U[20]+4*U[24]
    matriz_funciones_y[25] = lambda W,U: W[25]*((U[26]-U[24])/2)+U[25]*((U[31]-U[19])/2)-U[26]-U[24]-U[31]-U[19]+4*U[25]
    matriz_funciones_y[26] = lambda W,U: W[26]*((-U[25])/2)+U[26]*((U[32]-U[20])/2)-U[25]-U[32]-U[20]+4*U[26]
    matriz_funciones_y[27] = lambda W,U: W[27]*((U[28])/2)+U[27]*((U[33]-U[21])/2)-U[28]-U[33]-U[21]+4*U[27]
    matriz_funciones_y[28] = lambda W,U: W[28]*((U[29]-U[27])/2)+U[28]*((U[34]-U[22])/2)-U[29]-U[27]-U[34]-U[22]+4*U[28]
    matriz_funciones_y[29] = lambda W,U: W[29]*((-U[28])/2)+U[29]*((U[35]-U[23])/2)-U[28]-U[35]-U[23]+4*U[29]
    matriz_funciones_y[30] = lambda W,U: W[30]*((U[31])/2)+U[30]*((U[36]-U[24])/2)-U[31]-U[36]-U[24]+4*U[30]
    matriz_funciones_y[31] = lambda W,U: W[31]*((U[32]-U[30])/2)+U[31]*((U[37]-U[25])/2)-U[32]-U[30]-U[37]-U[25]+4*U[31]
    matriz_funciones_y[32] = lambda W,U: W[32]*((-U[31])/2)+U[32]*((U[38]-U[26])/2)-U[31]-U[38]-U[26]+4*U[32]
    matriz_funciones_y[33] = lambda W,U: W[33]*((U[34])/2)+U[33]*((-U[27])/2)-U[34]-U[27]+4*U[33]
    matriz_funciones_y[34] = lambda W,U: W[34]*((U[35]-U[33])/2)+U[34]*((-U[28])/2)-U[35]-U[33]-U[28]+4*U[34]
    matriz_funciones_y[35] = lambda W,U: W[35]*((-U[34])/2)+U[35]*((-U[29])/2)-U[34]-U[29]+4*U[35]
    matriz_funciones_y[36] = lambda W,U: W[36]*((U[37])/2)+U[36]*((-U[30])/2)-U[37]-U[30]+4*U[36]
    matriz_funciones_y[37] = lambda W,U: W[37]*((U[38]-U[36])/2)+U[37]*((-U[31])/2)-U[38]-U[36]-U[31]+4*U[37]
    matriz_funciones_y[38] = lambda W,U: W[38]*((-U[37])/2)+U[38]*((-U[32])/2)-U[37]-U[32]+4*U[38]
